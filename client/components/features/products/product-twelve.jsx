...
function ProductTwelve ( props ) {
    ...
    return (
        <div className="product product-7 text-center w-100 p-2">
            <figure className="product-media p-5y">
                {
                    product.status ?
                ...
                <ALink href={ `/product/default/${product.slug}` } className="">
                    <LazyLoadImage
            ...
            <div className="product-body">
                ...
                <div className="product-cat">
                       ...
                       <React.Fragment >
                       <ALink href={ { pathname: '/shop/sidebar/list', query: { category: product.name } } }>
