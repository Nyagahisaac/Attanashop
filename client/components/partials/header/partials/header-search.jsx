    ...
    return (
        <div className="header-search header-search-extended header-search-visible header-search-no-round">
            ...
            <form action="#" method="get" onSubmit={ onSubmitSearchForm } onClick={ showSearchForm }>
                <div className="header-search-wrapper search-wrapper-wide"  style={{border:"2px solid #fed700", borderRadius:"20px"}}>
                    <label htmlFor="q" className="sr-only" value={ searchTerm } required>Search</label>
                    <input type="text" onChange={ onSearchChange } value={ searchTerm } className="form-control" name="q" placeholder="Search product ..." required style={{borderBottomLeftRadius:"20px", borderTopLeftRadius:"20px"}} />
                    <button className="btn btn-warning" type="submit" style={{borderBottomRightRadius:"20px", borderTopRightRadius:"20px"}}><i className="icon-search"></i></button>
                </div>
