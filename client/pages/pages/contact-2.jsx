        ...
        <div className="main">
            ...
            <div className="page-content">
                ...
                <div className="container">
                    ...
                    <div className="row mt-5 mb-2 mt-md-5">
                        <div className="col-md-4">
                            <div className="contact-box text-center">
                                <h3>Office</h3>
                                <address>Miraj Plaza, Westlands, <br />NY 10004, Kenya</address>
                            </div>
                        </div>
                        ...
                        <div className="col-md-4">
                            <div className="contact-box text-center">
                                ...
                                <div><a href="mailto:#">info@toolsvilla.com</a></div>
